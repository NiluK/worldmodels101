...
const TEXT: Record<"en" | "zh", Text> = {
  en: {
    ...
    whatIfNote: "A Kalman filter can propagate a turn you hand it, but it has no way to learn the dynamics or to weigh this turn against another. It estimates; it does not plan.",
