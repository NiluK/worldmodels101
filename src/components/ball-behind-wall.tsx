...
const TEXT = {
  en: {
    ...
    vSpread: "Behind the wall the right answer is a spread of places.",
    ...
    vPoint: "Behind the wall the right answer is a spread of places. This model can only give a point.",
